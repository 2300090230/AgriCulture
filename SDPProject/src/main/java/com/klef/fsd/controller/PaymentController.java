        ...
        try {
            ...
            for (com.klef.fsd.dto.CartDTO cartItem : cartItems) {
                ...
                if (product.getFarmer() == null) {
                    logger.error("Product has no farmer: ProductId={}", product.getId());
                    throw new IllegalStateException("Product " + product.getName() + " has no associated farmer. Cannot create order.");
                }
