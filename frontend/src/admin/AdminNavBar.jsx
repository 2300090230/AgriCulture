    ...
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
      ...
      <div className="bg-white shadow-sm md:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center">
            ...
            <div className="text-green-600 font-bold text-xl">LL-FARM</div>
          </div>
      ...
      <div className={`${sidebarOpen ? 'block' : 'hidden'} md:block w-full md:w-72 bg-white shadow-lg md:h-screen fixed md:static top-0 left-0 z-20 transition-all duration-300`}>
        ...
        <Link to="/" className="flex flex-col items-center py-6 md:py-8 border-b border-gray-200">
          <div className="text-green-600 font-bold text-2xl md:text-3xl">LL-FARM</div>
          <div className="text-xs md:text-sm text-gray-500 mt-1">Agricultural Marketplace</div>
        </Link>
          ...
          <div className="px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center px-4 py-1 bg-green-50 rounded-full border border-green-100">
              ...
              <span className="text-sm font-medium text-green-700">
                ...
                {location.pathname === '/viewsellers' && 'View Farmers'}
                {location.pathname === '/sellerlobby' && 'Farmer Lobby'}
                {location.pathname === '/viewbuyers' && 'View Buyers'}
                {location.pathname === '/addseller' && 'Add Farmer'}
              </span>
            </div>
          </div>
        </div>
