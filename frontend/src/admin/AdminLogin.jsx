    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md">
        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">LL-FARM</h1>
          <p className="text-gray-500 mt-1">Agricultural Marketplace Admin</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 sm:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-2 sm:py-3 rounded-md hover:bg-green-700 transition duration-200 mb-4"
          >
            Sign In
          </button>
