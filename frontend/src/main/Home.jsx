...
import { FaShoppingCart, FaSeedling, FaAppleAlt, FaCarrot, FaLeaf, 
         FaTractor } from 'react-icons/fa'; 
...
export default function Home() {
  ...
  const categories = [
    { id: 1, name: "Seeds", icon: <FaSeedling size={24} /> },
    { id: 2, name: "Fruits", icon: <FaAppleAlt size={24} /> },
    { id: 3, name: "Vegetables", icon: <FaCarrot size={24} /> },
    { id: 4, name: "Organic", icon: <FaLeaf size={24} /> },
    { id: 5, name: "Equipment", icon: <FaTractor size={24} /> },
  ];

  // Flash deals data
  const deals = [
    { id: 1, title: "Fresh Harvest", discount: "30% OFF", color: "bg-green-600" },
    { id: 2, title: "Farmer Direct", discount: "NO MIDDLEMAN", color: "bg-green-700" },
    { id: 3, title: "Bulk Orders", discount: "EXTRA 20% OFF", color: "bg-green-800" },
  ];
  ...
  const ProductCard = ({ product, index, delay }) => (
    ...
    >
      ...
      <div className="relative h-48 bg-gray-100" style={{ cursor: 'pointer' }}>
        ...
        {/* Price tag */}
        <div className="absolute bottom-2 left-2 bg-green-500 text-white text-sm font-bold px-2 py-1 rounded-md">
          ₹{product.cost}
        </div>
      </div>
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            {categories.map((category) => (
              <button
                ...
                className="flex flex-col items-center justify-center p-2 hover:bg-green-50 rounded-lg transition-colors"
              >
                <div className="text-green-500 mb-2">{category.icon}</div>
        ...
        {/* Special Offers Scrollable Row */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">🌾 Today's Special Offers</h2>
          <div className="flex overflow-x-auto pb-2 hide-scrollbar">
            {deals.map((deal) => (
              ...
              >
                ...
                <button 
                  onClick={() => redirectToLogin('shop farm products')}
                  className="mt-2 bg-white text-green-800 px-3 py-1 rounded text-sm font-medium hover:bg-green-50 transition-colors"
                >
                  Shop Now
                </button>
              </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">🌱 Featured Farm Products</h2>
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-gray-800">🚜 Fresh From Farms</h2>
            <button 
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 bg-green-50 rounded-lg border-2 border-dashed border-green-300">
              <FaSeedling className="text-green-400 text-6xl mb-4" />
              <p className="text-gray-600 mb-2 font-medium">No farm products available at the moment</p>
              <p className="text-gray-500 text-sm">Check back soon for fresh produce!</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
