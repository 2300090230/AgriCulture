  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const [productsCount, ordersCount, revenueData, salesData] = await Promise.all([
          axios.get(`${config.url}/farmer/${sellerId}/products/count`),
          axios.get(`${config.url}/farmer/${sellerId}/orders/count`),
          axios.get(`${config.url}/farmer/${sellerId}/revenue`),
          axios.get(`${config.url}/farmer/${sellerId}/sales-data?period=${chartPeriod}`),
        ]);

        setStats({
          totalProducts: productsCount.data.totalProducts || 0,
          totalOrders: ordersCount.data.totalOrders || 0,
