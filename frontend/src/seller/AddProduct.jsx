...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("fid", seller.id);

    try {
      const response = await axios.post(
        `${config.url}/product/addproduct`,
        formData,
        {
          headers: {
      ...
      setMessage("");
      // Handle error response - extract message if it's an object
          ...
          >
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="relative">
                  <select
                    className="appearance-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-3 shadow-sm transition-all duration-300 focus:shadow-md hover:border-green-400"
                    id="category"
                    name="category"
                  ...
                  >
                    ...
                    {/* Farmer Produce Categories */}
                    <option value="Vegetables" className="py-2">
                      Vegetables
                    </option>
                    <option value="Fruits" className="py-2">
                      Fruits
                    </option>
                    <option value="Food Grains" className="py-2">
                      Food Grains
                    </option>
                    <option value="Pulses" className="py-2">
                      Pulses
                    </option>
                    <option value="Oil Seeds" className="py-2">
                      Oil Seeds
                    </option>
                    <option value="Spices" className="py-2">
                      Spices
                    </option>
                    <option value="Cereals" className="py-2">
                      Cereals
                    </option>
                    <option value="Millets" className="py-2">
                      Millets
                    </option>
                    <option value="Leafy Vegetables" className="py-2">
                      Leafy Vegetables
                    </option>
                    <option value="Dry Fruits" className="py-2">
                      Dry Fruits
                    </option>
                    <option value="Flowers" className="py-2">
                      Flowers
                    </option>
                    <option value="Sugarcane" className="py-2">
                      Sugarcane
                    </option>
                    <option value="Tea & Coffee" className="py-2">
                      Tea & Coffee
                    </option>
                    <option value="Cotton" className="py-2">
                      Cotton
                    </option>
                    <option value="Tobacco Leaves" className="py-2">
                      Tobacco Leaves
                    </option>
                    <option value="Wood & Timber" className="py-2">
                      Wood & Timber
                    </option>
                    <option value="Organic Farm Produce" className="py-2">
                  ...
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 bg-gradient-to-r from-green-500 to-green-700 h-full rounded-r-lg">
                    <svg
              ...
              >
                ...
                <input
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-3 transition-all duration-300 focus:shadow-md"
                  id="name"
                  type="text"
                  name="name"
                  value={product.name}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full pl-7 p-3 transition-all duration-300 focus:shadow-md"
                    id="cost"
                    type="number"
                    step="0.01"
                    name="cost"
            ...
            {previewUrl && (
              ...
              >
                ...
                <div className="border-2 border-green-200 rounded-lg p-2 w-full flex justify-center bg-gray-50">
                  <img
                    src={previewUrl}
                    alt="Product Preview"
            ...
            >
              <button
                className={`relative overflow-hidden px-8 py-3 bg-gradient-to-r from-green-500 to-green-700 text-white font-medium rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 ${
