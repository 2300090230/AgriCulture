  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${config.url}/buyer/reset-password`,
        null,
        {
          params: {
            token: token,
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 mt-1">Agricultural Marketplace</p>
        </div>
        ...
        {!token ? (
          <div className="text-center my-6">
            ...
            <Link
              to="/forgotpassword"
              className="block w-full bg-green-600 text-white py-2.5 rounded-lg font-medium hover:bg-green-700 transition-colors"
            >
              Request New Link
            </Link>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                  required
                  minLength={6}
                />
                <button
        ...
        <div className="text-center mt-4">
          <Link
            to="/buyerlogin"
            className="text-green-600 hover:text-green-800 font-medium hover:underline block"
          >
            Back to Sign In
          </Link>
        </div>
