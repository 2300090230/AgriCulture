      ...
      {pageLoading ? (
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition duration-300">
          <div className="bg-gradient-to-r from-green-500 to-green-700 px-6 py-4">
            ...
            <p className="text-green-100 text-sm">Manage your account information and delivery addresses</p>
          </div>
            ...
            <>
              {isEditing ? (
                <form onSubmit={handleEditSubmit} className="p-6">
                  <div className="flex flex-col md:flex-row gap-8">
                    <div className="w-full md:w-1/3 flex flex-col items-center justify-start p-4 border-2 border-dashed border-gray-300 rounded-lg">
                      <div className="w-32 h-32 bg-gradient-to-r from-green-500 to-green-700 rounded-full flex items-center justify-center text-4xl text-white mb-4 shadow-lg transition duration-500 hover:scale-105">
                    ...
                    <div className="w-full md:w-2/3 space-y-6">
                      ...
                      <div className="flex justify-between pt-4">
                        ...
                        <button
                          type="submit"
                          className="px-6 py-2.5 bg-green-600 text-white font-medium rounded-md hover:bg-green-700 transition flex items-center"
                          disabled={isLoading}
                        >
                          {isLoading ? (
                            <>
                    ...
                    <div className="w-full md:w-1/3 flex flex-col items-center justify-start p-4 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500 flex items-center justify-center">
                          <FaMapMarkerAlt className="mr-1 text-green-500" /> {buyer.address || "Address not set"}
                        </div>
                      </div>
                    </div>
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition flex items-center text-sm"
                >
              ...
              {addressLoading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <button 
                    onClick={handleAddAddressClick}
                    className="px-6 py-2.5 bg-green-600 text-white rounded-md hover:bg-green-700 transition flex items-center mx-auto"
                  >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          {!address.isDefault && (
                            <button
                              ...
                              className="text-sm text-green-600 hover:text-green-800 p-1.5 hover:bg-green-50 rounded-md transition flex items-center"
                          ...
                          <button 
                            ...
                            className="text-sm text-gray-600 hover:text-green-600 p-1.5 hover:bg-green-50 rounded-md transition"
                            title="Edit"
                          >
                  ...
                  <div 
                    onClick={handleAddAddressClick}
                    className="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center py-8 cursor-pointer hover:border-green-300 hover:bg-gray-50 transition"
                  >
          ...
          <div className="bg-white rounded-lg max-w-lg w-full mx-auto animate-slideDown overflow-hidden">
            ...
            <form onSubmit={handleSaveAddress} className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 font-medium flex items-center"
